...
const sonidos = {
    "1": cargarSonido("../assets/mp3/1.mp3"),
    "2": cargarSonido("../assets/mp3/2.mp3"),
    "3": cargarSonido("../assets/mp3/3.mp3"),
    "4": cargarSonido("../assets/mp3/4.mp3"),
    "5": cargarSonido("../assets/mp3/1.mp3"),
    "6": cargarSonido("../assets/mp3/2.mp3"),
    "7": cargarSonido("../assets/mp3/3.mp3"),
    "8": cargarSonido("../assets/mp3/4.mp3"),
    "9": cargarSonido("../assets/mp3/4.mp3"),
};
...
function mostrarGameOver(time) {
    ...
    crearPartida(nombreJugador, score, timeInMinutes, userId);
